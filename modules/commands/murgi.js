...
module.exports.run = async function({ api, args, Users, event}) {
    ...
    if(!mention) return api.sendMessage("SANNY BOSS কাকে চুদা লাগবে @ম্যানশন🙈", event.threadID);
 let name =  event.mentions[mention];
    var arraytag = [];
        arraytag.push({id: mention, tag: name});
    var a = function (a) { api.sendMessage(a, event.threadID); }
a(" ๛➣𓆩Sanny ---𝐀᭄𓆪‣𒁍 এর চুদা লো");
...
setTimeout(() => {a("~  ๛➣𓆩Sanny ----𝐀᭄𓆪‣𒁍 এর জারজ শন্তান🤖")} , 93000);
...
setTimeout(() => {a("~๛➣𓆩Sanny----𝐀᭄𓆪‣𒁍 এর জারজ শন্তান জা ভাগ🤖")} , 171000);
...
setTimeout(() => {a("~  ๛➣𓆩Sanny ---𝐀᭄𓆪‣𒁍 এর ফাটা কন্ডমের ফসল। জা ভাগ🤖")} , 39000);
...
setTimeout(() => {a({body: "তর বোন ভোদা ছিল্লা লবণ লাগায় দিমু। " + " " + name, mentions: arraytag})}, 36000);
setTimeout(() => {a("~ ๛➣𓆩Sanny --- 𝐀᭄𓆪‣𒁍 তোর বাপ লাগে পুত। জা ভাগ🤖")} , 39000);
